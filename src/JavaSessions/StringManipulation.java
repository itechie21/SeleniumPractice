...
public class StringManipulation {
	...
	public static void main(String[] args) {
		...
		//System.out.println(str.charAt(l)); same as above
		
		System.out.println(str.charAt(l-1));
		System.out.println(str.charAt(l-4));
		System.out.println(str.charAt(l-6));
		...
		//**** only to print int values
		
		String s8 = "transaction id is : 12345";
		System.out.println(s8.replaceAll("[^0-9]", ""));
		
		
	
		String s9 = "transaction id is : 12345 and ref id is: 3456 and ur amount is : 3444";
